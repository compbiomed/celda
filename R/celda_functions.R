...
#' @param error.on.mismatch Whether to stop execution in the event of a count matrix mismatch. Defaults to TRUE.
...
#' @export
compareCountMatrix = function(count.matrix, celda.obj, error.on.mismatch=TRUE) {
